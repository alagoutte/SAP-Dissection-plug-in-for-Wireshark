...
static int
dissect_sapdiag(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
	...
	proto_tree_add_item(header_tree, hf_sapdiag_err_flag, tvb, offset, 1, ENC_BIG_ENDIAN); offset++;
